...
## Video/Image Objection Detection Using CenterNet
...
**2.** To do real-time inference on a video, use:
  ...
  ```
  python demo.py --model <Select your model> --testiter <Enter '480000' if using pretrained model> --file <./path/to/video.mp4> --score <Remove bboxes based on this score> <--save>
  ```

  Example:

  ```
  python demo.py --model CenterNet-104 --testiter 480000 --file road.mp4 --score 0.5 --save
  ```    
