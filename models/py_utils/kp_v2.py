...
from .utils_v2 import convolution, residual
from .utils_v2 import make_layer, make_layer_revr, make_up_layer            # Added make_up_layer

from .kp_utils_v2 import _tranpose_and_gather_feat, _decode
from .kp_utils_v2 import _sigmoid, _ae_loss, _regr_loss, _neg_loss
from .kp_utils_v2 import make_tl_layer, make_br_layer, make_kp_layer, make_ct_layer
from .kp_utils_v2 import make_pool_layer, make_unpool_layer
from .kp_utils_v2 import make_merge_layer, make_inter_layer, make_cnv_layer

class kp_module(nn.Module):
    def __init__(
        self, n, dims, modules, layer=residual,
        make_up_layer=make_up_layer, make_low_layer=make_layer,             # Let make_up_layer = make_up_layer
...
class kp(nn.Module):
    def __init__(
        ...
        make_up_layer=make_up_layer, make_low_layer=make_layer, 
        make_hg_layer=make_layer, make_hg_layer_revr=make_layer_revr,
        make_pool_layer=make_pool_layer, make_unpool_layer=make_unpool_layer,
