...
class kp(nn.Module):
    def __init__(
        self, 
        #db, 
        n, nstack, dims, modules, out_dim, pre=None, cnv_dim=256, 
        ...
        #self._db                = db
        self.K                  = db_configs.top_k
        self.ae_threshold       = db_configs.ae_threshold
        self.kernel             = db_configs.nms_kernel
        self.input_size         = db_configs.input_size[0]
        self.output_size        = db_configs.output_sizes[0][0]
